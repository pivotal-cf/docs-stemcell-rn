class StemcellRelease
  attr_reader :name, :version_string, :version_major, :version_minor, :prerelease, :date, :body
  ...
  def version_major?(other_version_major)
    version_major == other_version_major
  end
